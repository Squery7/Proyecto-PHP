...
<div id="catalogo" class="catalogo">
  ...
  for ($i=0; $i < 4; $i++) { 
    ...
    $variable = $variable .'<div class="div-imagen">';
    $variable = $variable . '  <img class="card-img-top" src="https://tienda.sophosenlinea.com/imagenes/9788491/978849129239.GIF" alt="Card image cap">';
    ...
    $variable = $variable . '    <a href="#" class="btn btn-primary" id="btn-primary">Detalles</a>';
    $variable = $variable . '  </div>';
    $variable = $variable . '</div>';
    echo $variable;   
  }
